...
// WithAPIClientSecret sets the apiClientSecret request header.
func WithAPIClientSecret(apiClientSecret string) *core.APIClientSecretOption {
	return &core.APIClientSecretOption{
